...
public class CatalogShower extends HttpServlet {
    ...
    private void handleCitations(HttpServletRequest request, List<String> journalTitles, String title, JOURNAL_OPTION option) {
        try {
            CitationBeanRemote ejbCit = (CitationBeanRemote) InitialContext.doLookup("java:jboss/exported/DemoEAR/Enterprise-Java-Beans/CitationBean!ejbs.CitationBeanRemote");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter(ACTION.ACTION1.action) != null) {
            ...
            handleCitations(request, journalsWeb.getTitles(), title, JOURNAL_OPTION.UNIQUE);
