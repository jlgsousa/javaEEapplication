...
public class Client {
    ...
    public static void main(String[] args) throws NamingException {
    	...
    	CitationBeanRemote citationRemote = (CitationBeanRemote) InitialContext.doLookup("DemoEAR/Enterprise-Java-Beans/CitationBean!ejbs.CitationBeanRemote");
    	JournalBeanRemote journalRemote = (JournalBeanRemote) InitialContext.doLookup("DemoEAR/Enterprise-Java-Beans/JournalBean!ejbs.JournalBeanRemote");
